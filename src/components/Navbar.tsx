        ...
        >
            <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
                ...
                <div className="hidden md:flex gap-8 items-center">
                    ...
                    <a
                        href="/resume.pdf"
                        download="Dharani_C_Resume.pdf"
                        className="px-5 py-2 text-xs font-bold uppercase tracking-widest border border-[var(--color-text)]/20 rounded-full hover:bg-[var(--color-primary)] hover:text-black hover:border-[var(--color-primary)] transition-all text-[var(--color-text)] flex items-center justify-center"
                    >
                        Resume
                    </a>
                </div>
                        ...
                        <div className="flex flex-col p-6 gap-4">
                            ...
                            <div className="pt-4 border-t border-[var(--color-border)] mt-2">
                                <a
                                    href="/resume.pdf"
                                    download="Dharani_C_Resume.pdf"
                                    className="w-full py-4 rounded-2xl glass-card flex items-center justify-center gap-2 text-[var(--color-primary)] font-bold uppercase tracking-widest"
                                    onClick={() => setMobileMenuOpen(false)}
                                >
                                    Download Resume
                                </a>
